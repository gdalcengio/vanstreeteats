...
<body>
    ...
    <section class="centered">
        ...
        <form action="user_pref_update.php" method="POST">
            <h2>change your info</h2>
            <div class="form-input">
                <!-- name -->
                <label for="name">name:</label>
                <input type="text" name="name" value="<?php echo $user["fullname"]; ?>" required>
            </div>
            <div class="form-input">
            ...
            <div class="form-input">
                ...
                <select name="ePref">;
                    <?php echo "<option value=\"".$user["e_pref"]."\" selected disabled hidden>".$user["e_pref"]."</option>" ?>
            ...
            <div class="form-input">
                ...
                <select name="fPref">;
                    <?php echo "<option value=\"".$user["f_pref"]."\" selected disabled hidden>".$user["f_pref"]."</option>" ?>
        ...
        <?php closeConnection($connection, $result); ?>
    </section>
</body>
</html>
